 ...
 */
final class NsharedpreferencesConverter implements Converter {

  private final Parser parser;

  public NsharedpreferencesConverter(Parser parser) {
    if (parser == null) {
  ...
  @Override public <T> T fromString(String value, DataInfo info) throws Exception {
    ...
    NsharedpreferencesUtils.checkNull("data info", info);
