 ...
 */
public final class Npref {

  private Npref() {
    // no instance
  }

  static NsharedpreferencesFacade nsharedpreferencesFacade = new NsharedpreferencesFacade.EmptyNsharedpreferencesFacade();

  /**
   * This will init the hawk without password protection.
   *
   * @param con is used to instantiate context based objects.
   *                ApplicationContext will be used
   */
  public static NsharedpreferencesBuilder init(Context con) {
    NsharedpreferencesUtils.checkNull("Context", con);
    nsharedpreferencesFacade = null;
    return new NsharedpreferencesBuilder(con);
  }

  static void build(NsharedpreferencesBuilder nsharedpreferencesBuilder) {
    nsharedpreferencesFacade = new DefaultNsharedpreferencesFacade(nsharedpreferencesBuilder);
  }
  ...
  public static <T> boolean put(String key, T value) {
    return nsharedpreferencesFacade.put(key, value);
  }

  /**
   * Gets the original data along with original type by the given key.
   * This is not guaranteed operation since Npref uses serialization. Any change in in the requested
  ...
  public static <T> T get(String key) {
    return nsharedpreferencesFacade.get(key);
  }
  ...
  public static <T> T get(String key, T defaultValue) {
    return nsharedpreferencesFacade.get(key, defaultValue);
  }
  ...
  public static long count() {
    return nsharedpreferencesFacade.count();
  }
  ...
  public static boolean deleteAll() {
    return nsharedpreferencesFacade.deleteAll();
  }
  ...
  public static boolean delete(String key) {
    return nsharedpreferencesFacade.delete(key);
  }
  ...
  public static boolean contains(String key) {
    return nsharedpreferencesFacade.contains(key);
  }

  /**
   * Use this method to verify if Npref is ready to be used.
   *
   * @return true if correctly initialised and built. False otherwise.
   */
  public static boolean isBuilt() {
    return nsharedpreferencesFacade.isBuilt();
  }

  public static void destroy() {
    nsharedpreferencesFacade.destroy();
  }
